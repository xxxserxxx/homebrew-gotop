class Gotop < Formula
  ...
  url "https://github.com/xxxserxxx/gotop/releases/download/v3.3.2/gotop_3.3.2_darwin_amd64.tgz"
  sha256 "aaf63438179befa1b19515258910a64317126be9348040298e87162998645d46"
  version "3.3.2"

  if OS.linux?
    url "https://github.com/xxxserxxx/gotop/releases/download/v3.3.2/gotop_3.3.2_linux_amd64.tgz"
